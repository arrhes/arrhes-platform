...
import { generateIncomeStatementReportDocumentRouteDefinition } from "@arrhes/metadata/routes"
...
export const generateIncomeStatementReportDocumentRoute = authFactory.createApp()
    .post(
        generateIncomeStatementReportDocumentRouteDefinition.path,
        bodyValidator(generateIncomeStatementReportDocumentRouteDefinition.schemas.body),
        async (c) => {
            ...
            const htmlResponse = await c.html(incomeStatementReportTemplate({
