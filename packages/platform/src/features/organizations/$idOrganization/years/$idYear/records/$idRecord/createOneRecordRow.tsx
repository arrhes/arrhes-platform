import { createOneRecordRowRouteDefinition, readAllAccountsRouteDefinition, readAllRecordRowsRouteDefinition, readOneRecordRouteDefinition } from "@arrhes/schemas/routes"
