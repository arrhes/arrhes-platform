import { createOneRecordRouteDefinition, readAllAttachmentsRouteDefinition, readAllJournalsRouteDefinition, readAllRecordsRouteDefinition } from "@arrhes/schemas/routes"
