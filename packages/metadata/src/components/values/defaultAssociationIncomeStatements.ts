import type { DefaultIncomeStatement } from "./defaultIncomeStatement.js"
...
export const defaultAssociationIncomeStatements: DefaultIncomeStatement[] = [
    ...
    },
    {
        ...
        numberParent: 1,
        accounts: [
            7133, 71331, 71335, 7134, 71341, 71345, 7135, 71351, 71355, 71358, 721, 722, 741, 742, 747, 751, 7511, 7516,
            7518, 752, 757, 758, 7581, 7582, 7583, 7584, 7585, 7586, 7587, 7588,
        ],
    },
    {
        number: 2,
    ...
    },
    {
        ...
        numberParent: 2,
        accounts: [
            604, 605, 606, 6061, 6063, 6064, 6068, 608, 609, 6098, 611, 6122, 6125, 613, 6132, 6135, 614, 615, 6152,
            6155, 6156, 616, 6161, 6162, 6163, 61636, 61637, 61638, 6164, 6165, 617, 618, 6181, 6183, 6185, 619, 621,
            6211, 6214, 622, 6221, 6222, 6224, 6225, 6226, 62264, 6227, 6228, 623, 6231, 6232, 6233, 6234, 6235, 6236,
            6237, 6238, 624, 6241, 6242, 6243, 6244, 6247, 6248, 625, 6251, 6255, 6256, 6257, 626, 627, 6271, 6272,
            6275, 6276, 6278, 628, 6281, 6284, 629,
        ],
    },
    {
        number: 24,
    ...
    },
    {
        ...
        numberParent: 2,
        accounts: [
            631, 6311, 6314, 6318, 633, 6331, 6332, 6333, 6334, 6335, 6338, 635, 6351, 63511, 63512, 63513, 63514, 6352,
            6353, 6354, 63541, 6358, 637, 6371, 6372, 6374, 6378, 638,
        ],
    },
    {
        number: 26,
