...
export const defaultCompanyIncomeStatements: DefaultIncomeStatement[] = [
    ...
    },
    {
        ...
        numberParent: 1,
        accounts: [
            701, 702, 703, 704, 705, 706, 708, 7081, 7082, 7083, 7084, 7085, 7086, 7087, 7088, 7091, 7092, 7094, 7095,
            7096, 7098,
        ],
    },
    {
    ...
    },
    {
        ...
        accounts: [
            ...
            6211, 6214, 622, 6221, 6222, 6224, 6225, 6226, 6227, 6228, 623, 6231, 6232, 6233, 6234, 6235, 6236, 6237,
            6238, 624, 6241, 6242, 6243, 6244, 6247, 6248, 625, 6251, 6255, 6256, 6257, 626, 627, 6271, 6272, 6275,
            6276, 6278, 628, 6281, 6284, 629,
        ],
    },
    {
        number: 26,
