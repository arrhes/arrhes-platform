                        ...
                        return (
                            <Section.Root>
                                <Section.Item>
                                    ...
                                    >
                                        <UpdateOneAttachment attachment={attachment}>
                                            <ButtonContent
                                                variant="primary"
                                                leftIcon={<IconPencil />}
                                                text="Modifier"
                                        ...
                                        <DeleteOneAttachment attachment={attachment}>
                                    ...
                                    <DataBlock.Root>
                                        ...
                                        <DataBlock.Content>
                                            ...
                                            <DataBlock.Item label="Libellé">
                                                <FormatText>{attachment.label}</FormatText>
                                            </DataBlock.Item>
                                            <DataBlock.Item label="Date">
                                                <FormatDate date={attachment.date} />
                                            </DataBlock.Item>
                                            <DataBlock.Item label="Type">
                                                <FormatText>{attachment.type?.split("/").at(1)}</FormatText>
                                            </DataBlock.Item>
                                    ...
                                    <DataBlock.Root>
                                        ...
                                        <DataBlock.Content>
                                            ...
                                            <DataBlock.Item label="Id">
                                                <FormatText>{attachment.id}</FormatText>
                                            </DataBlock.Item>
                                        </DataBlock.Content>
                                    </DataBlock.Root>
                                </Section.Item>
