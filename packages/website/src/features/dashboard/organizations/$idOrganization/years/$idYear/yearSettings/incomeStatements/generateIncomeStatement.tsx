        ...
        <Dialog.Root open={open} onOpenChange={(value) => setOpen(value)}>
            ...
            {open === false ? null : (
                <Dialog.Content>
                    ...
                    >
                        <Dialog.Title>Voulez-vous générer les lignes de compte de résultat par défaut ?</Dialog.Title>
                        <Dialog.Description>
                            Cette action supprimera les anciennes lignes de compte de résultat pour générer celles par
                            défaut.
                            <br />
                    ...
                    <Dialog.Footer>
                        ...
                        <Button
                            onClick={async () => {
                                ...
                                if (!response.ok) {
                                    toast({
                                        title: "Impossible de générer les lignes de compte de résultat",
                                        variant: "error",
                                    })
                                    return false
                                }
                                ...
                                toast({
                                    title: "Lignes de compte de résultat générées avec succès",
                                    variant: "success",
                                })
