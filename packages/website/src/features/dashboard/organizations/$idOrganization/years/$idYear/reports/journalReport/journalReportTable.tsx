...
export function JournalReportTable(props: {
    ...
    const sortedRecords = props.records.sort((a, b) => b.date.localeCompare(a.date))
                                ...
                                >
                                    ...
                                    <Table.Body.Cell className={css({ width: "[1%]" })} align="right">
                                        <FormatPrice
                                            ...
                                            className={cx(
                                                css({ fontWeight: "bold" }),
                                                compareAmounts({ a: recordTotalDebit, b: recordTotalCredit })
                                                    ? ""
                                                    : css({ color: "error" }),
                                            )}
                                        />
                                                        ...
                                                        >
                                                            {(account) => (
                                                                <Fragment>
                                                                    ...
                                                                    <FormatText
                                                                        wrap={true}
                                                                        className={css({ color: "neutral/50" })}
                                                                    >
                                                                        {account.label}
                                                                    </FormatText>
                                                                </Fragment>
