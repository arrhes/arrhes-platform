    ...
    return (
        <DocRoot>
            ...
            <DocSection title="Pourquoi numériser vos documents ?">
                <DocParagraph>
                    Chaque{" "}
                    <DocLink to="/documentation/comptabilité/écritures">écriture comptable</DocLink>{" "}
                    doit être justifiée par une pièce (facture, relevé bancaire, ticket de caisse...).
                    Arrhes vous permet de stocker ces documents numériquement, directement associés
                    à vos écritures, pour un archivage sécurisé et une consultation rapide.
                </DocParagraph>
                <DocParagraph>
                    La numérisation de vos justificatifs facilite les contrôles, les échanges
                    avec votre expert-comptable et la recherche de documents en cas de besoin.
                </DocParagraph>
            </DocSection>
            ...
            <DocSection title="Ajouter une pièce jointe">
                <DocParagraph>
                    Les pièces jointes sont associées directement aux écritures comptables.
                    Vous pouvez les ajouter lors de la{" "}
                    <DocLink to="/documentation/dashboard/écritures">saisie d'une écriture</DocLink>{" "}
                    ou ultérieurement.
                </DocParagraph>
            ...
            <DocSection title="Consulter et gérer vos fichiers">
                <DocParagraph>
                    Depuis une écriture, vous pouvez visualiser, télécharger ou supprimer
                    les pièces jointes associées. Les fichiers PDF et images peuvent être
                    prévisualisés directement dans l'application.
                </DocParagraph>
                <DocList items={[
            ...
            <DocTip variant="info">
                La conservation des pièces justificatives est une obligation légale.
                Arrhes vous aide à organiser vos documents numériquement, mais pensez
                également à conserver vos originaux papier conformément à la réglementation.
            </DocTip>
