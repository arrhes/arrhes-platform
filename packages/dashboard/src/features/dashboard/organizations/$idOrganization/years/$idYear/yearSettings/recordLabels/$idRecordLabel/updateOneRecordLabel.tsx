import { readAllRecordLabelsRouteDefinition, readOneRecordLabelRouteDefinition, updateOneRecordLabelRouteDefinition } from "@arrhes/application-metadata/routes"
