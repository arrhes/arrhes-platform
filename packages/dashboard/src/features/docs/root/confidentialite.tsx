        ...
        <div className={css({
            ...
            <div className={css({
                ...
                <Section title="1. Responsable du traitement">
                    <p>
                        Le responsable du traitement des données personnelles est Arrhes SAS,
                    ...
                    <p>
                        ...
                        contacter à l'adresse : privacy@arrhes.fr
                    </p>
                </Section>
                ...
                <Section title="3. Finalités du traitement">
                    ...
                    <ul>
                        <li>Fournir et améliorer le service Arrhes</li>
                ...
                <Section title="5. Durée de conservation">
                    ...
                    <ul>
                        ...
                        <li>Données comptables : conservées 10 ans conformément à la loi</li>
                ...
                <Section title="9. Vos droits">
                    ...
                    <p>
                        Pour exercer ces droits, contactez-nous à privacy@arrhes.fr ou utilisez
                        les fonctionnalités disponibles dans votre compte.
                    </p>
                </Section>
